...
#+BEGIN_SRC clojure :noweb-ref macros
  (defmacro defentity
    ...
    (let [->sym      (comp symbol clojure.core/name)
          props      (merge {:type {:prop "rdf:type" :validate [(v/required)]}} props)
         ...
         (defn ~ctor
           ...
           (let [[opts# err#]
                 (-> opts#
                     ...
                     ;;((fn [_#] (prn :pre-init _#) _#))
                     (eu/apply-initializers inits#)
                     ;;((fn [_#] (prn :post-init _#) _#))
                     (eu/inject-defaults defaults#)
                     ;;((fn [_#] (prn :post-default _#) _#))
...
#+BEGIN_SRC clojure :tangle ../babel/src/cljx/thi/ng/trio/entities.clj :noweb yes :mkdirp yes :padline no
...
#+BEGIN_SRC clojure :tangle ../babel/src/cljx/thi/ng/trio/entities/utils.cljx :noweb yes :mkdirp yes :padline no
