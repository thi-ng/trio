...
- any qvars with aliasing or transformation fns are processed/renamed
...
(reductions) for both grouped and ungrouped result sets. Aggregate
...
There are differences in how such aggregate qvars appear in the
...
| *Grouping* | *:select contains* | *:select contains*   | *Solution format*                                                                  |
|            | *aggregate vars*   | *non-aggregate vars* |                                                                                    |
|------------+--------------------+----------------------+------------------------------------------------------------------------------------|
| <c>        | <c>                | <c>                  |                                                                                    |
...
*Note:* Aggregate qvars will not automatically appear in the solution
