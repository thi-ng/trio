...
anything we know subjects matched via an initial query/search, in this
case people with nicknames and who are younger than 40. A =:describe=
query returns all triples in which a bound result var is either a
subject or object.
